          ...
          >
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+12012126338" className="font-[family-name:var(--font-montserrat)] text-gray-400 transition-colors hover:text-[#C9A962]">
                  +1 (201) 212-6338
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:sales@truvinonj.com" className="font-[family-name:var(--font-montserrat)] text-gray-400 transition-colors hover:text-[#C9A962]">
                  sales@truvinonj.com
                </a>
              </li>
            </ul>
